...
class Player(PacMan, BasePlayer):
    ...
    def look(self, ghosts: Ghosts) -> None:
        ...
        Can see: Whether it can move in any of the 4 cardinal directions (4 one-hot values),
         and whether there is a Ghost in any of the cardinal directions (4 one-hot values).
